<template>
    ...
    >
        ...
        <va-dropdown-content
            class="notification-dropdown__content pl-3 pr-3 pt-2 pb-2"
        >
            <div
                ...
                :class="{
                    'notification-dropdown__item--unread': notification.unread,
                }"
            ...
            >
                ...
                <span class="ellipsis" style="max-width: 85%">
                    <span v-if="notification.details.name" class="text--bold">{{
                        notification.details.name
                    }}</span>
                    {{
                        t(`notifications.${notification.name}`, {
            ...
            <div class="row justify--space-between mt-1">
                <va-button class="md6 mr-2" size="small">{{
                    t("notifications.all")
                }}</va-button>
                <va-button
                    class="md6"
...
const allRead = computed(() => {
    return notificationsProxy.value.every(
