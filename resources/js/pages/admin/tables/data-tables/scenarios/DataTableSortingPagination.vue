    ...
    <va-card :title="t('tables.sortingPaginationActionsAsIcons')">
        <va-data-table :fields="fields" :data="users" :per-page="5">
            <template #actions="props">
                <va-popover
                    :message="getStarMessage(props.rowData)"
                    placement="top"
                >
                    <va-button
                        preset="plain"
                ...
                <va-popover
                    :message="`${t('tables.edit')} ${props.rowData.fullName}`"
                    placement="top"
                >
                    <va-button
                        preset="plain"
                ...
                <va-popover
                    :message="`${t('tables.delete')} ${props.rowData.fullName}`"
                    placement="top"
                >
                    <va-button
                        preset="plain"
...
export default {
    ...
    methods: {
        getStarMessage(user) {
            const actionName = user.starred
                ? this.t("tables.unstar")
                : this.t("tables.star");
