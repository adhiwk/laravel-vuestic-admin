...
const tabs = {
    OverviewTab: defineAsyncComponent(
        () => import("./dashboard-tabs/OverviewTab.vue")
    ),
    BillingAddressTab: defineAsyncComponent(
        () => import("./dashboard-tabs/BillingAddressTab.vue")
    ),
    BankDetailsTab: defineAsyncComponent(
        () => import("./dashboard-tabs/BankDetailsTab.vue")
    ),
};
