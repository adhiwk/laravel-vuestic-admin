        ...
        <div class="row">
                    ...
                    <va-card-content class="row">
                        <div class="flex">
                            <va-button class="mr-2 mb-2">
                                {{ t("buttons.default") }}</va-button
                            >
                            <va-button class="mr-2 mb-2" disabled>
                            ...
                            >
                                {{ t("buttons.disabled") }}</va-button
                            >
                            <va-button class="mr-2 mb-2" preset="plain">
                                {{ t("buttons.flat") }}</va-button
                            >
                            <va-button
                                class="mr-2 mb-2"
                                preset="plain"
            ...
            <div class="flex xs12">
                <va-card class="larger-padding">
                    ...
                    <va-card-content class="row">
                        <div class="flex">
                            <va-button class="mr-2 mb-2" size="small">
                                {{ t("buttons.small") }}</va-button
                            >
                            <va-button class="mr-2 mb-2">
                                {{ t("buttons.normal") }}</va-button
                            >
                            <va-button class="mr-2 mb-2" size="large">
                                {{ t("buttons.large") }}</va-button
                            >
                        </div>
                    </va-card-content>
                </va-card>
            ...
            <div class="flex xs12">
                <va-card class="larger-padding">
                    ...
                    <va-card-content>
                        <div class="row">
                            <div class="flex">
                                <va-button class="mr-2 mb-2" color="danger">
                                    {{ t("buttons.danger") }}</va-button
                                >
                                <va-button class="mr-2 mb-2" color="info">
                                    {{ t("buttons.info") }}</va-button
                                >
                                <va-button class="mr-2 mb-2" color="dark">
                                    {{ t("buttons.dark") }}</va-button
                                >
                                <va-button class="mr-2 mb-2" color="warning">
                                    {{ t("buttons.warning") }}</va-button
                                >
                                <va-button class="mr-2 mb-2" color="success">
                                    {{ t("buttons.success") }}</va-button
                                >
                                <va-button class="mr-2 mb-2" color="gray">
                        ...
                        <div class="row">
                            ...
                            <div class="flex xs12 xl6">
                                <va-button-group
                                    ...
                                    color="danger"
                                >
                                    <va-button icon="maki-art-gallery"
                                        >One</va-button
                                    >
                            ...
                            <div class="flex xs12 xl6">
                                ...
                                >
                                    ...
                                    <va-button icon-right="glyphicon-pencil"
                                        >Second</va-button
                                    >
