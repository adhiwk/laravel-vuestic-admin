                ...
                <va-card class="mb-4 px-3">
                    <va-list class="py-4">
                        ...
                        <va-list-item class="mb-2" clickable>
                            <va-list-item-section>
                                <va-list-item-label
                                    >Add profile images</va-list-item-label
                                >

                                <va-list-item-label caption
                                    >You can use PNG or JPG
                        ...
                        <va-list-item clickable>
                            <va-list-item-section>
                                <va-list-item-label
                                    >Invite friends</va-list-item-label
                                >

                                <va-list-item-label caption
                                    >You can send invitations via email or any
                                    messenger.</va-list-item-label
                                >
                            </va-list-item-section>
                        </va-list-item>
                        ...
                        <va-list-item class="mb-2">
                            ...
                            <va-list-item-section>
                                <va-list-item-label
                                    >Application Banners</va-list-item-label
                                >
                        ...
                        <va-list-item>
                            ...
                            <va-list-item-section>
                                <va-list-item-label
                                    >Midnight Notifications</va-list-item-label
                                >
                            </va-list-item-section>
                        </va-list-item>
                    </va-list>
                ...
                <va-card class="px-3">
                    <va-list class="py-4">
                        ...
                        <va-list-item :to="{ name: 'maplibre-maps' }">
                            ...
                            <va-list-item-section>
                                <va-list-item-label
                                    >MapLibre Maps</va-list-item-label
                                >
                            </va-list-item-section>
                        </va-list-item>
                        ...
                        <va-list-item :to="{ name: 'yandex-maps' }">
                            ...
                            <va-list-item-section>
                                <va-list-item-label
                                    >Yandex Maps</va-list-item-label
                                >
                            </va-list-item-section>
                        </va-list-item>
                        ...
                        <va-list-item :to="{ name: 'leaflet-maps' }">
                            ...
                            <va-list-item-section>
                                <va-list-item-label
                                    >Leaflet Maps</va-list-item-label
                                >
                            </va-list-item-section>
                        </va-list-item>
                    </va-list>
