            ...
            <va-card-content>
                <div class="row mt-0">
                    <div class="d-flex flex xs12 lg4 align--center">
                        <span class="shrink pr-3 spinners__size-smaller"
                            >A</span
                        >
                        <va-slider
                            v-model="config.size"
                    ...
                    <div class="d-flex flex xs12 lg4 align--center">
                        <va-icon-slower
                            class="shrink pr-3 spinners__duration-slower"
                        />
                        <va-slider
                        ...
                        />
                        <va-icon-faster
                            class="shrink pl-3 spinners__duration-faster"
                        />
                    </div>
                ...
                <div v-for="(group, i) in groups" :key="i" class="row">
                    ...
                    >
                        <div class="va-text-center pb-4">
                            <div
                                class="justify-center d-flex align-center spinner-box"
                            >
                                <component
...
const groups = computed(() =>
    groupItems(Object.keys(spinners) as SpinnersItems[], config.value.group)
);
