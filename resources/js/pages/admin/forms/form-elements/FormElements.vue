                            ...
                            <div class="row">
                                ...
                                <div class="flex md4 sm6 xs12">
                                    <va-date-input
                                        ...
                                        :label="
                                            t(
                                                'forms.dateTimePicker.manualInput'
                                            )
                                        "
                                        manual-input
                                    />
                            ...
                            <div class="row">
                                ...
                                <div class="flex md6 xs12">
                                    <va-select
                                        ...
                                        :label="
                                            t('forms.selects.searchableMulti')
                                        "
                                        text-by="description"
                                        searchable
                                        multiple
