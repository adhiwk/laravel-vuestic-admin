<template>
    <div class="charts">
        <div class="row">
            ...
            <div class="flex md6 xs12">
                <va-card
                    v-if="horizontalBarChartDataGenerated"
                    class="chart-widget"
                >
                    <va-card-title>{{
                        t("charts.horizontalBarChart")
                    }}</va-card-title>
                    <va-card-content>
                        <va-chart
                            :data="horizontalBarChartDataGenerated"
                            type="horizontal-bar"
                        />
                    </va-card-content>
                </va-card>
        ...
        <div class="row">
            ...
            <div class="flex md6 xs12">
                <va-card v-if="doughnutChartDataGenerated" class="chart-widget">
                    ...
                    <va-card-content>
                        <va-chart
                            :data="doughnutChartDataGenerated"
                            type="doughnut"
                        />
                    </va-card-content>
                </va-card>
