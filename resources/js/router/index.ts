                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/statistics/charts/Charts.vue"
                            ),
                        meta: {
                            wikiLink:
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/forms/form-elements/FormElements.vue"
                            ),
                        meta: {
                            wikiLink:
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/maps/maplibre-maps/MapLibreMapsPage.vue"
                            ),
                        meta: {
                            wikiLink:
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/maps/yandex-maps/YandexMapsPage.vue"
                            ),
                        meta: {
                            wikiLink:
                                "https://github.com/epicmaxco/vuestic-admin/wiki/Maps",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/maps/leaflet-maps/LeafletMapsPage.vue"
                            ),
                        meta: {
                            wikiLink:
                                "https://github.com/epicmaxco/vuestic-admin/wiki/Maps",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/maps/bubble-maps/BubbleMapsPage.vue"
                            ),
                        meta: {
                            wikiLink:
                                "https://github.com/epicmaxco/vuestic-admin/wiki/Maps",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/maps/line-maps/LineMapsPage.vue"
                            ),
                        meta: {
                            wikiLink:
                                "https://github.com/epicmaxco/vuestic-admin/wiki/Maps",
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/tables/markup-tables/MarkupTables.vue"
                            ),
                        meta: {
                            wikiLink:
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "../pages/admin/tables/data-tables/DataTables.vue"
                            ),
                        meta: {
                            wikiLink:
                                "https://github.com/epicmaxco/vuestic-admin/wiki/Tables",
                ...
                children: [
                    {
                        ...
                        path: "404-pages",
                        component: () =>
                            import("../pages/admin/pages/404PagesPage.vue"),
                    },
                    {
                        name: "faq",
                        path: "faq",
                        component: () =>
                            import("../pages/admin/pages/FaqPage.vue"),
                    },
                ],
            },
            UIRoute,
        ...
        children: [
            {
                ...
                component: () =>
                    import("../pages/404-pages/VaPageNotFoundSearch.vue"),
            },
            {
                name: "not-found-simple",
                path: "not-found-simple",
                component: () =>
                    import("../pages/404-pages/VaPageNotFoundSimple.vue"),
            },
            {
                name: "not-found-custom",
                path: "not-found-custom",
                component: () =>
                    import("../pages/404-pages/VaPageNotFoundCustom.vue"),
            },
            {
